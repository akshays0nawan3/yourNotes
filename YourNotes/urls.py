...
urlpatterns = [
	...
	path('?P<username>/?P<title>/updatenoteprocess', views.updateNoteprocess_view, name="updatenoteprocess"),
	path('?P<username>/?P<title>/notedetails', views.noteDetails_view, name="notedetails"),
